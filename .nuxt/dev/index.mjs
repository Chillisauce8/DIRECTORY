...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/devalue/index.js';
import destr from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/unctx/dist/index.mjs';
import { packString } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/packrup/dist/index.mjs';
import { version, unref } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/jamesbaddiley/Documents/car/car/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/api/**": {
        "proxy": {
          "to": "https://testorigin.chillisauce.com/api/**",
          "_proxyStripBase": "/api"
        }
      },
      "/login/**": {
        "proxy": {
          "to": "https://testorigin.chillisauce.com/login/**",
          "_proxyStripBase": "/login"
        }
      },
      "/logout/**": {
        "proxy": {
          "to": "https://testorigin.chillisauce.com/logout/**",
          "_proxyStripBase": "/logout"
        }
      },
      "/register/**": {
        "proxy": {
          "to": "https://testorigin.chillisauce.com/register/**",
          "_proxyStripBase": "/register"
        }
      },
      "/my-events/**": {
        "ssr": false,
...
const serverAssets = [{"baseName":"server","dir":"/Users/jamesbaddiley/Documents/car/car/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jamesbaddiley/Documents/car/car","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jamesbaddiley/Documents/car/car/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jamesbaddiley/Documents/car/car/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jamesbaddiley/Documents/car/car/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jamesbaddiley/Documents/car/car/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _DQkHzPUhC8 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$2}<\/script>`);
  });
});

const rootDir = "/Users/jamesbaddiley/Documents/car/car";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _ZW25go0Com = (nitroApp) => {
...
const _rf4ab8sIu7 = defineNitroPlugin((nitro) => {
...
const _ccTApywtLe = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_CKjfA4 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_CKjfA4, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CKjfA4, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en-gb"}};
...
const getClientManifest = () => import('file:///Users/jamesbaddiley/Documents/car/car/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/jamesbaddiley/Documents/car/car/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
