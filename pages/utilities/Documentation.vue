...
npm run dev</code></pre>
                    ...
                    <div class="font-semibold text-xl my-4">Layout Composable</div>
                    <p class="text-lg mb-4">
                        The <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">composables/useLayout.ts</span> is a an auto-imported composable that manages the layout state changes including dark mode, PrimeVue theme, menu
