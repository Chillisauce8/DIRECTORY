...
const sidebarItems = computed(() => {
    ...
    return [
        { label: 'Inbox', icon: 'pi pi-inbox', badge: mails.inbox?.length || 0, routerLink: '/new/mail/inbox' },
        { label: 'Starred', icon: 'pi pi-star', badge: mails.starred?.length || 0, routerLink: '/new/mail/starred' },
        { label: 'Spam', icon: 'pi pi-ban', badge: mails.spam?.length || 0, routerLink: '/new/mail/spam' },
        { label: 'Important', icon: 'pi pi-bookmark', badge: mails.important?.length || 0, routerLink: '/new/mail/important' },
        { label: 'Sent', icon: 'pi pi-send', badge: mails.sent?.length || 0, routerLink: '/new/mail/sent' },
        { label: 'Archived', icon: 'pi pi-book', badge: mails.archived?.length || 0, routerLink: '/new/mail/archived' },
        { label: 'Trash', icon: 'pi pi-trash', badge: mails.trash?.length || 0, routerLink: '/new/mail/trash' }
    ];
});
