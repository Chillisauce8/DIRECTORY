...
<template>
    <FormBuilder :unformattedForm="unformattedForm"
                 id="test form" :title="title" :subtitle="subtitle" />
</template>
...
const unformattedForm = ref(null);

httpService.get(`/api/sys/definitions/test_form`)
  .then((response: any) => {
    unformattedForm.value = response.data.properties;
  });
