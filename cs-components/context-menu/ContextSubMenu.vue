...
<script lang="ts">
import { type MenuOptions, type MenuItem, type ContextMenuPositionData, MenuConstOptions, type MenuPopDirection } from './ContextMenuDefine'
...
<style lang="scss">
@import "../../assets/css/_context-menu-base.scss";
</style>