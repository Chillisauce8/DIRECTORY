    ...
    <ImageWrapper cloudinaryId="6558d0b3c409d60f99a0d198" :width="1000" class="footer-content">
      ...
      <section class="footer-links">
        <template v-for="linkSection in footerLinks"
          ...
          <reveal-item class="footer mobile"
...
export default {
  ...
  created() {
    ...
    this.subscribeOnSectionStoreChanges();
  },
  unmounted() {
    if (this.sectionStoreSubscription) {
      this.sectionStoreSubscription();
      this.sectionStoreSubscription = undefined;
    }
  },
  data() {
