...
<template>
    <i class="icon">
        ...
        <svg v-else-if="svg === 'sun'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'sun-pin'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'chevron-right'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M5.651 23.5l12.576-11.126a.5.5 0 000-.748L5.651.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <svg v-else-if="svg === 'chevron-down'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M.541 5.627 11.666 18.2a.5.5 0 0 0 .749 0L23.541 5.627" stroke-linecap="round" stroke-linejoin="round" />
        </svg>

        <svg v-else-if="svg === 'chevron-left'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M18.4.5 5.825 11.626a.5.5 0 0 0 0 .748L18.4 23.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>

        <svg v-else-if="svg === 'chevron-up'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M23.535 18.373 12.409 5.8a.5.5 0 0 0-.749 0L.535 18.373" stroke-linecap="round" stroke-linejoin="round" />
        </svg>

        <svg v-else-if="svg === 'phone'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <svg v-else-if="svg === 'hotel'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'activity'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'beer'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'cocktail'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'nightlife'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'compass'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M.5 12a11.5 11.5 0 1023 0 11.5 11.5 0 10-23 0z" />
                <path d="M14.968 13.641a2 2 0 01-1.077 1.077L7.213 17.5a.5.5 0 01-.662-.631L9.03 9.984a1.994 1.994 0 011.2-1.2L17.12 6.3a.5.5 0 01.631.662z" />
                <path d="M10.5 12a1.5 1.5 0 103 0 1.5 1.5 0 10-3 0zM12 2.5v1M21.5 12h-1M18.718 18.718l-.708-.708M12 21.5v-1M2.5 12h1M5.282 5.282l.708.708" />
            </g>
        </svg>

        <svg v-else-if="svg === 'map'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'map-pin'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 .71a7.5 7.5 0 017.5 7.5c0 3.547-5.5 12.381-7.079 14.85a.5.5 0 01-.842 0C10 20.592 4.5 11.757 4.5 8.21A7.5 7.5 0 0112 .71z" />
                <path d="M9 8.21a3 3 0 106 0 3 3 0 10-6 0z" />
            </g>
        </svg>

        <svg v-else-if="svg === 'eye'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'eye-close'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'cog'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'filters'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            <path
        ...
        <svg v-else-if="svg === 'list'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M8.5 4.498h15M8.5 12.498h15M8.5 20.498h15M.5 2.498h4v4h-4zM.5 10.498h4v4h-4zM.5 18.498h4v4h-4z" />
            </g>
        </svg>

        <svg v-else-if="svg === 'help'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                ...
                <path d="M9.056 8a3 3 0 114.2 2.751 2 2 0 00-1.2 1.833V13M12.056 15.25a.25.25 0 11-.25.25.25.25 0 01.25-.25" />
            </g>
        </svg>

        <svg v-else-if="svg === 'info'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'warning'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'date'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M.5 2.501h23v21H.5zM5.5.501v5M18.5.501v5M.5 7.501h23M6.5 19.001h5" />
                <path d="M9 19v-7.5a.5.5 0 00-.812-.391L6.5 12.46M15.5 19l2.931-7.255a.469.469 0 00-.005-.5.546.546 0 00-.464-.245H14a.5.5 0 00-.5.5v1" />
            </g>
        </svg>

        <svg v-else-if="svg === 'bin'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'edit'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M7 21.5l-6.5 2 2-6.5L15.33 4.169l4.5 4.5L7 21.5z" />
                <path d="M15.33 4.169l3.086-3.086a2.007 2.007 0 012.828 0l1.672 1.672a2 2 0 010 2.828L19.83 8.669M17.58 6.419L6 18M2.5 17l1 1H6v2.5l1 1M1.5 20.5l2 2M16.83 2.669l4.5 4.5" />
            </g>
        </svg>

        <svg v-else-if="svg === 'check-circle'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'check-circle-fill'" class="fill" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg v-else-if="svg === 'question-circle'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke="#000">
        ...
        <svg v-else-if="svg === 'add-circle'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'remove-circle'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M7 16.999l10-10M17 16.999l-10-10M.5 11.999a11.5 11.5 0 1023 0 11.5 11.5 0 10-23 0z" />
            </g>
        </svg>

        <svg v-else-if="svg === 'copy'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M6.521 10.497H12.5M6.521 10.497H12.5M9.51 7.508v5.979M9.51 7.508v5.979M16.302 8.548l3.06-2.002-1.705 8.809" />
                <path d="M23.5 1.5a1 1 0 00-1-1h-18a1 1 0 00-1 1v18a1 1 0 001 1h18a1 1 0 001-1z" />
                <path d="M3.5 4.5h-2a1 1 0 00-1 1v17a1 1 0 001 1h17a1 1 0 001-1v-2" />
            </g>
        </svg>

        <svg v-else-if="svg === 'close'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M23.5.5l-23 23M23.5 23.5L.5.5" />
            </g>
        </svg>

        <svg v-else-if="svg === 'add'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 1v22M23 12H1" />
            </g>
        </svg>

        <svg v-else-if="svg === 'reload'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'component'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'play'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M.5 11.999a11.5 11.5 0 1023 0 11.5 11.5 0 10-23 0z" />
        ...
        <svg v-else-if="svg === 'clock'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'bus'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'nightclub'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'beach'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'plane'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'meal'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'heart'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg v-else-if="svg === 'heart2'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            <path d="M16 28c7-4.73 14-10 14-17a6.98 6.98 0 0 0-7-7c-1.8 0-3.58.68-4.95 2.05L16 8.1l-2.05-2.05a6.98 6.98 0 0 0-9.9 0A6.98 6.98 0 0 0 2 11c0 7 7 12.27 14 17z" />
        </svg>

        <svg v-else-if="svg === 'email'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'group'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'person'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'boy'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'girl'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'gun'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'target'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'drinks'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'jeep'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'squid'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <svg v-else-if="svg === 'star'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <svg v-else-if="svg === 'rocket'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'octopus'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'rugby'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'windsurf'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'pound-circle'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'cherries'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'bra'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'surfing'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'helmet'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'flight'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'camping'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'climbing'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'thumb-up'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
                    class="a"
        ...
        <svg v-else-if="svg === 'song'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'cupcake'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'snowboard'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'vip-circle'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="11.5" />
                <path d="M12 9v6M11 15h2M11 9h2" />
                <g>
                    <path d="M18 10.5a1.5 1.5 0 0 1-1.5 1.5H15V9h1.5a1.5 1.5 0 0 1 1.5 1.5ZM15 15v-3" />
                </g>
                <path d="M9 9v1.5A7.53 7.53 0 0 1 7.5 15 7.53 7.53 0 0 1 6 10.5V9" />
            </g>
        </svg>

        <svg v-else-if="svg === 'ticket'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'heels'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'atv'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'graduate'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'flame'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'torch'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'viking'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'fast-food'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'wine'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'irish'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'lips'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'strawberry'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'pottery'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'world'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'champagne'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'alert'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'submarine'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'bell'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'linkedin'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg v-else-if="svg === 'note'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'lotus'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'six-pack'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'setting'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'ten'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'stag'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'capital'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'infinity'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-else-if="svg === 'tick'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg v-else-if="svg === 'double-tick'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'castle'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'piggy-bank'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'moustache'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <svg v-else-if="svg === 'purse'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'skyscraper'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path
        ...
        <svg v-else-if="svg === 'book'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'invite'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'point'" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <svg v-else-if="svg === 'facebook'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M17.768 7.5H13.5V5.6a.972.972 0 011.012-1.1c.418 0 2.988.01 2.988.01V.5h-4.329C9.244.5 8.5 3.474 8.5 5.355V7.5h-3v4h3v12h5v-12h3.851z" stroke-linecap="round" stroke-linejoin="round" />
        </svg>

        <svg v-else-if="svg === 'twitter'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <svg v-else-if="svg === 'pinterest'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <svg v-else-if="svg === 'instagram'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g stroke-linecap="round" stroke-linejoin="round">
                <path d="M.5.5h23v23H.5z" />
                <path d="M6 12a6 6 0 1012 0 6 6 0 10-12 0zM17.5 5a1.5 1.5 0 103 0 1.5 1.5 0 10-3 0z" />
            </g>
        </svg>

        <svg v-else-if="svg === 'youtube'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg v-else-if="svg === 'dial'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg v-else-if="svg === 'dial2'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            />
            <rect width="9" height="3" x="7.5" y="16.5" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" rx=".5" ry=".5" />
        </svg>

        <svg v-else-if="svg === 'steering'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="11.5" stroke-linecap="round" stroke-linejoin="round" />
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.822 9.736a27.673 27.673 0 0 1 16.356 0" />
            <circle cx="12" cy="12" r="8.5" fill="none" stroke-linecap="round" stroke-linejoin="round" />
            <circle cx="12" cy="12" r="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" />
            <path
                fill="none"
                stroke="#000"
                stroke-linecap="round"
        ...
        <svg v-else-if="svg === 'arrow-left'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <defs />
            <path
        ...
        <svg v-else-if="svg === 'whatsapp'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <defs />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.5 -0.5 24 24" v-else-if="svg === 'headphone-user'">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12.930791666666668 12.456416666666666a2.385291666666667 2.385291666666667 0 0 1 -2.861583333333334 0" />
            <path d="M9.592916666666667 10.30975a0.238625 0.238625 0 0 1 0 -0.47725" />
            <path d="M9.592916666666667 10.30975a0.238625 0.238625 0 1 0 0 -0.47725" />
            <path d="M13.407083333333334 10.30975a0.238625 0.238625 0 0 1 0 -0.47725" />
            <path d="M13.407083333333334 10.30975a0.238625 0.238625 0 1 0 0 -0.47725" />
            <path stroke-linecap="round" stroke-linejoin="round" d="M17.224125 8.163083333333335a5.724125 5.724125 0 0 0 -11.44825 0v1.9080416666666669a5.724125 5.724125 0 1 0 11.44825 0v-1.9070833333333335Z" />
            <path
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            />
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.901375 7.44625a7.632166666666667 7.632166666666667 0 0 1 15.19725 0" />
            <path
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            />
            <path stroke-linecap="round" stroke-linejoin="round" d="M7.7625 17.524083333333337a3.8160833333333337 3.8160833333333337 0 0 0 7.4750000000000005 0" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 24 24" v-else-if="svg === 'calendar'">
            <defs />
            ...
            <path
                ...
                stroke-linejoin="round"
            />
            <path d="m3.354166666666667 1.4384583333333334 0 2.875" stroke-linecap="round" stroke-linejoin="round" />
            <path d="m7.1875 1.4384583333333334 0 2.875" stroke-linecap="round" stroke-linejoin="round" />
            <path d="m11.020833333333334 1.4384583333333334 0 2.875" stroke-linecap="round" stroke-linejoin="round" />
            <path d="m14.854166666666668 1.4384583333333334 0 2.875" stroke-linecap="round" stroke-linejoin="round" />
            <path d="m18.6875 1.4384583333333334 0 2.875" stroke-linecap="round" stroke-linejoin="round" />
            <path
            ...
            <path
                ...
                stroke-linejoin="round"
            />
            <path d="M11.020833333333334 11.980125h3.8333333333333335v3.8333333333333335h-3.8333333333333335Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M14.854166666666668 11.980125h3.8333333333333335v3.8333333333333335h-3.8333333333333335Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M11.020833333333334 15.813458333333335h3.8333333333333335v3.8333333333333335h-3.8333333333333335Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M14.854166666666668 15.8125h3.8333333333333335l0 0v2.875a0.9583333333333334 0.9583333333333334 0 0 1 -0.9583333333333334 0.9583333333333334h-2.875l0 0v-3.8333333333333335l0 0Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M4.3125 11.979166666666668h2.875l0 0v3.8333333333333335l0 0h-3.8333333333333335l0 0v-2.875a0.9583333333333334 0.9583333333333334 0 0 1 0.9583333333333334 -0.9583333333333334Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M7.1875 11.980125h3.8333333333333335v3.8333333333333335h-3.8333333333333335Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M3.354166666666667 15.8125h3.8333333333333335l0 0v3.8333333333333335l0 0h-2.875a0.9583333333333334 0.9583333333333334 0 0 1 -0.9583333333333334 -0.9583333333333334v-2.875l0 0Z" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M7.1875 15.813458333333335h3.8333333333333335v3.8333333333333335h-3.8333333333333335Z" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'search'" viewBox="-0.5 -0.5 24 24">
            <path d="M0.4791666666666667 10.0625a9.583333333333334 9.583333333333334 0 1 0 19.166666666666668 0 9.583333333333334 9.583333333333334 0 1 0 -19.166666666666668 0" stroke-linecap="round" stroke-linejoin="round" />
            <path d="m22.520833333333336 22.520833333333336 -5.681958333333334 -5.681958333333334" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 24 24" v-else-if="svg === 'cruise'">
            <defs />

            <path d="m19.904583333333335 17.868125 2.61625 -5.170208333333333H3.6991666666666667a0.4791666666666667 0.4791666666666667 0 0 0 -0.45425 0.32775000000000004L1.4375 18.447916666666668" stroke-linecap="round" stroke-linejoin="round" />
            <path
            ...
            <path
                ...
                stroke-linejoin="round"
            />
            <path d="M12.453541666666666 5.98575 8.624041666666667 2.15625" stroke-linecap="round" stroke-linejoin="round" />
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 24 24" v-else-if="svg === 'flight-baggage'">
            <g>
                <g>
                    <path
                    ...
                    <path
                        ...
                        stroke-linejoin="round"
                    />
                    <path d="m18.6875 4.3125 0 7.1875" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="m15.8125 4.3125 0 7.1875" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" />
                    <path d="m7.1875 4.3125 0 15.333333333333334" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="m4.3125 4.3125 0 15.333333333333334" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 24 24" v-else-if="svg === 'megaphone'">
            <path d="m7.1875 6.612500000000001 0 8.294375a6.892333333333334 6.892333333333334 0 0 0 3.8333333333333335 6.176458333333334" stroke-linecap="round" stroke-linejoin="round"></path>
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'drawn-arrow-1'" viewBox="-1 -1 26 26">
            <g>
                <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'drawn-arrow-2'" viewBox="-1 -1 26 26">
            <path
        ...
        <svg viewBox="-0.25 -0.25 24 24" xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'x-circle'">
            <path d="M0.9781875 11.75a10.770833333333332 10.770833333333332 0 1 0 21.541666666666664 0 10.770833333333332 10.770833333333332 0 1 0 -21.541666666666664 0Z" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="m15.902645833333333 7.596375 -8.308229166666665 8.308229166666665" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M15.902645833333333 15.904604166666665 7.594416666666667 7.596375" stroke-linecap="round" stroke-linejoin="round"></path>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-else-if="svg === 'pickleball-player'">
            <g>
                <path d="M13 3a2.5 2.5 0 1 0 5 0 2.5 2.5 0 1 0 -5 0" stroke-linecap="round" stroke-linejoin="round"></path>
                <path
                ...
                ></path>
                <g>
                    <path d="m4.87 7.5 2.8 2.8" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M1.4384123318 7.0687572106A2.72 2.12 45 1 0 4.436545084 4.0706244584a2.72 2.12 45 1 0 -2.9981327522 2.9981327522" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
                <path d="M1.5 13a1.5 1.5 0 1 0 3 0 1.5 1.5 0 1 0 -3 0" stroke-linecap="round" stroke-linejoin="round"></path>
            </g>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'sunbathe'" viewBox="0 0 24 24">
            <path
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-miterlimit="10"
                d="M18.2 8.008a2.208 2.208 0 1 0 0-4.416 2.208 2.208 0 0 0 0 4.416ZM18.2 1.7V.8M18.2 10.8v-1M15.4 2.9l-.7-.7M21.8 9.3l-.7-.7M14.2 5.8h-1M23.2 5.8h-.9M15.4 8.6l-.7.7M21.8 2.2l-.7.7M.8 10.3l7 9.5h12.4M7.794 19.8l-1 3.4M17.2 19.8l1 3.4M4.242 9.3a2.082 2.082 0 1 0 0-4.164 2.082 2.082 0 0 0 0 4.164Z"
            />
            <path
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-miterlimit="10"
                d="M14.26 15.057c-3.38 1.56-4.421 2.101-4.903 2.03a1.293 1.293 0 0 1-.942-.603l-2.573-3.585c-.563-.751-.23-2.135.652-2.666.912-.55 1.983-.163 2.452.4l2.12 2.967 2.19-.795a2.773 2.773 0 0 1 2.91.657l1.895 1.93c.657.657.482 1.42-.081 1.89-.563.468-1.39.289-1.954-.274l-1.766-1.95Z"
            />
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'red-flag'" viewBox="0 0 24 24">
            <g>
                <path
                    d="M16.55 7.2a0.27 0.27 0 0 1 0 -0.4l6 -4.78c0.52 -0.42 0.48 -0.81 0.42 -1S22.67 0.5 22 0.5H6a0.5 0.5 0 0 0 -0.5 0.5v12a0.5 0.5 0 0 0 0.5 0.5h16c0.66 0 0.88 -0.32 0.95 -0.52s0.1 -0.58 -0.42 -1Z"
                    fill="red"
                    stroke-width="1"
                ></path>
                <path d="M2.51 0A1.5 1.5 0 0 0 1 1.5v21a1.5 1.5 0 0 0 3 0v-21A1.5 1.5 0 0 0 2.51 0Z" fill="#000000" stroke-width="1"></path>
            </g>
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'medal'" viewBox="0 0 24 24">
            <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M10.003.749v7M14.003.749v7M12.003.749v7M12 .749H7a1 1 0 0 0-1 1V3.12a1 1 0 0 0 .033.255L8.5 12.75M12 .749h5a1 1 0 0 1 1 1V3.12a1 1 0 0 1-.033.255L15.5 12.75M12.706 11.181l1.539 3.57h2.995a.735.735 0 0 1 .516 1.283l-2.6 2.316 1.44 3.313a.785.785 0 0 1-1.117.982L12 20.684l-3.48 1.961a.785.785 0 0 1-1.12-.982l1.44-3.313-2.6-2.315a.735.735 0 0 1 .514-1.284h3l1.541-3.57a.8.8 0 0 1 1.411 0Z"
            />
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" v-else-if="svg === 'medal-1'" viewBox="0 0 24 24">
            <path
                class="strap"
                stroke-width="0.5"
                d="M6.7 7.62a0.75 0.75 0 0 0 1 0.42 9.25 9.25 0 0 1 8.56 0 0.77 0.77 0 0 0 0.63 0 0.78 0.78 0 0 0 0.44 -0.47l1.29 -4a1.71 1.71 0 0 0 0.09 -0.55V1.75A1.75 1.75 0 0 0 17 0H7a1.75 1.75 0 0 0 -1.76 1.75v1.33a1.79 1.79 0 0 0 0.09 0.57Z"
            ></path>
            <path class="circle" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.5" d="M4.5 16a7.5 7.5 0 1 0 15 0 7.5 7.5 0 1 0 -15 0Z"></path>
            <path
                class="star"
                stroke-linecap="round"
                stroke-linejoin="round"
                stroke-width="0.5"
                d="M12.472 12.287 13.5 14.5h2a0.49 0.49 0 0 1 0.346 0.855l-1.736 1.71 0.962 2.209a0.524 0.524 0 0 1 -0.746 0.655L12 18.622l-2.322 1.307a0.524 0.524 0 0 1 -0.746 -0.655l0.962 -2.209 -1.736 -1.708A0.489 0.489 0 0 1 8.5 14.5h2l1.029 -2.215a0.53 0.53 0 0 1 0.943 0.002Z"
            ></path>
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-else-if="svg === 'medal-2'">
            <path
                fill="none"
                stroke="#000"
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M4.5 16a7.5 7.5 0 1 0 15 0 7.5 7.5 0 1 0-15 0ZM12.5.5h-5a1 1 0 0 0-1 1v1.333a.992.992 0 0 0 .054.324L8.042 7.5M12.5.5h5.021a1 1 0 0 1 1 1v1.342a.973.973 0 0 1-.049.308L17.063 7.5M9.5.5v6M15.5.5v6M12.5.5v6"
            />
            <path
                fill="none"
                stroke="#000"
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M12.472 12.287 13.5 14.5h2a.49.49 0 0 1 .346.855l-1.736 1.71.962 2.209a.524.524 0 0 1-.746.655L12 18.622l-2.322 1.307a.524.524 0 0 1-.746-.655l.962-2.209-1.736-1.708A.489.489 0 0 1 8.5 14.5h2l1.029-2.215a.53.53 0 0 1 .943.002Z"
            />
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-else-if="svg === 'gearstick'">
            <g>
                <path d="M23.5 20.5a1 1 0 0 0 -1 -1h-21a1 1 0 0 0 -1 1V23a0.51 0.51 0 0 0 0.5 0.5h22a0.51 0.51 0 0 0 0.5 -0.5Z" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path>

                <path d="m9.5 16.5 0 -8" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path>
                <path d="M5.5 4.5a4 4 0 1 0 8 0 4 4 0 1 0 -8 0" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path>

                <path d="M22.08 19a0.61 0.61 0 0 1 -0.58 0.49h-19a0.61 0.61 0 0 1 -0.58 -0.49l+5.42 -2.5h4Z" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path>
            </g>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-else-if="svg === 'solidtick'">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 26 26" v-else-if="svg === 'roundtick'">
            <path
                fill-rule="evenodd"
                d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Zm6.005-15.054a1.286 1.286 0 0 0-2.008-1.606l-6.079 7.598-2.432-1.824a1.286 1.286 0 1 0-1.542 2.057l3.428 2.572a1.286 1.286 0 0 0 1.776-.226l6.857-8.571Z"
                clip-rule="evenodd"
            />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 26 26" v-else-if="svg === 'cardsmall'">
            <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 26 26" v-else-if="svg === 'cardsbig'">
            <path
                fill-rule="evenodd"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 26 26" v-else-if="svg === 'cardsmall-fill'">
            <path
                d="M1.75.25h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M1.75 8.75h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M1.75 17.25h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M10.25.25h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M10.25 8.75h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M10.25 17.25h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M18.75.25h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M18.75 8.75h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5M18.75 17.25h3.5s1.5 0 1.5 1.5v3.5s0 1.5-1.5 1.5h-3.5s-1.5 0-1.5-1.5v-3.5s0-1.5 1.5-1.5"
            />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 26 26" v-else-if="svg === 'cardsbig-fill'">
            <path
                fill-rule="evenodd"
                d="M1.902.25A1.65 1.65 0 0 0 .252 1.9v7.2a1.65 1.65 0 0 0 1.65 1.65h7.2a1.65 1.65 0 0 0 1.65-1.65V1.9A1.65 1.65 0 0 0 9.102.25h-7.2Zm12.997 0a1.65 1.65 0 0 0-1.65 1.65v7.2a1.65 1.65 0 0 0 1.65 1.65h7.2a1.65 1.65 0 0 0 1.65-1.65V1.9a1.65 1.65 0 0 0-1.65-1.65h-7.2ZM.735 13.733c.31-.31.73-.483 1.167-.483h7.2a1.65 1.65 0 0 1 1.65 1.65v7.2a1.65 1.65 0 0 1-1.65 1.65h-7.2a1.65 1.65 0 0 1-1.65-1.65v-7.2c0-.438.174-.857.483-1.167ZM14.9 13.25a1.65 1.65 0 0 0-1.65 1.65v7.2a1.65 1.65 0 0 0 1.65 1.65h7.2a1.65 1.65 0 0 0 1.65-1.65v-7.2a1.65 1.65 0 0 0-1.65-1.65h-7.2Z"
                clip-rule="evenodd"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-else-if="svg === 'move'">
            <path
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" v-else-if="svg === 'move2'">
