...
var _environment = _interopRequireDefault(await jitiImport("./environment"));
var _useTheme = await jitiImport("./composables/useTheme");
var _vitePluginCommonjs = _interopRequireDefault(await jitiImport("vite-plugin-commonjs"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };} // https://nuxt.com/docs/api/configuration/nuxt-config

const { DefaultTheme } = (0, _useTheme.useTheme)();var _default = exports.default =
...
defineNuxtConfig({
  ...
  ssr: _environment.default.ssr ?? true,

  css: [
  (0, _path.resolve)(__dirname, './assets/css/global.scss'),
  (0, _path.resolve)(__dirname, './assets/styles.scss'),
  (0, _path.resolve)(__dirname, './assets/tailwind.css'),
    ...
    css: {
      preprocessorOptions: {
        scss: {
          additionalData: `
                        @use "sass:math";
                        @use "${(0, _path.resolve)(__dirname, './assets/css/vars')}" as *;
                        @use "${(0, _path.resolve)(__dirname, './assets/css/_mixins')}" as *;
                    `
        }
      }
    },
  ...
  plugins: [
  { src: (0, _path.resolve)(__dirname, './plugins/app.js') },
  { src: (0, _path.resolve)(__dirname, './plugins/default-http-interceptors.ts') },
  { src: (0, _path.resolve)(__dirname, './plugins/js-extend.ts') }],
  ...
  hooks: {
    'pages:extend': (pages) => {
      pages.push({
        ...
        file: (0, _path.resolve)(__dirname, './pages/new/test-form.vue')
      });
      pages.push({
        name: 'Market List',
        path: '/market',
        file: (0, _path.resolve)(__dirname, './pages/market/list.vue')
      });
      pages.push({
        name: 'Market',
        path: '/market/:slug+',
        file: (0, _path.resolve)(__dirname, './pages/market/slug.vue')
      });

      pages.push({
        name: 'index',
        path: '/',
        file: (0, _path.resolve)(__dirname, './pages/index.vue')
      });
      pages.push({
        name: 'message',
        path: '/new/message',
        file: (0, _path.resolve)(__dirname, './pages/new/Message.vue'),
        children: [
        {
          path: '',
      ...
      pages.push({
        ...
        },
        {
          path: 'inbox',
          name: 'message-inbox',
          file: (0, _path.resolve)(__dirname, './pages/new/message/[folder].vue')
        },
        {
          path: 'compose',
          name: 'message-compose',
  ...
  */
  ...
  nitro: {
    devProxy: _environment.default.devProxy ?? {},
    routeRules: {
      '/api/auth/**': { cors: true, security: { xframe: 'DENY' } },
      ...(_environment.default?.routeRules ?? {})
    },
    publicAssets: [
    {
      dir: 'docs/**/*',
