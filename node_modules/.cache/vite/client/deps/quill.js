...
function match(node, prefix2) {
  return (node.getAttribute("class") || "").split(/\s+/).filter((name) => name.indexOf(`${prefix2}-`) === 0);
}
...
var _ShadowBlot = class _ShadowBlot2 {
  ...
  offset(root4 = this.parent) {
    return this.parent == null || this === root4 ? 0 : this.parent.children.offset(this) + this.parent.offset(root4);
  }
  optimize(_context) {
...
var __CJS__export_default__ = (module2.exports == null ? {} : module2.exports).default || module2.exports;

// node_modules/lodash.clonedeep/index.js
var lodash_exports = {};
__export(lodash_exports, {
  default: () => __CJS__export_default__2
});
var module3 = { exports: {} };
...
var freeExports4 = typeof exports3 == "object" && exports3 && !exports3.nodeType && exports3;
...
var __CJS__export_default__2 = (module3.exports == null ? {} : module3.exports).default || module3.exports;

// node_modules/lodash.isequal/index.js
var lodash_exports2 = {};
__export(lodash_exports2, {
  default: () => __CJS__export_default__3
});
var module4 = { exports: {} };
...
var typedArrayTags2 = {};
typedArrayTags2[float32Tag5] = typedArrayTags2[float64Tag5] = typedArrayTags2[int8Tag5] = typedArrayTags2[int16Tag5] = typedArrayTags2[int32Tag5] = typedArrayTags2[uint8Tag5] = typedArrayTags2[uint8ClampedTag5] = typedArrayTags2[uint16Tag5] = typedArrayTags2[uint32Tag5] = true;
typedArrayTags2[argsTag6] = typedArrayTags2[arrayTag5] = typedArrayTags2[arrayBufferTag7] = typedArrayTags2[boolTag7] = typedArrayTags2[dataViewTag7] = typedArrayTags2[dateTag7] = typedArrayTags2[errorTag6] = typedArrayTags2[funcTag5] = typedArrayTags2[mapTag12] = typedArrayTags2[numberTag7] = typedArrayTags2[objectTag7] = typedArrayTags2[regexpTag7] = typedArrayTags2[setTag12] = typedArrayTags2[stringTag7] = typedArrayTags2[weakMapTag6] = false;
...
var freeExports5 = typeof exports4 == "object" && exports4 && !exports4.nodeType && exports4;
var freeModule5 = freeExports5 && typeof module4 == "object" && module4 && !module4.nodeType && module4;
var moduleExports5 = freeModule5 && freeModule5.exports === freeExports5;
var freeProcess2 = moduleExports5 && freeGlobal3.process;
...
function baseTimes3(n, iteratee2) {
  var index = -1, result2 = Array(n);
  while (++index < n) {
    result2[index] = iteratee2(index);
  }
...
function overArg3(func, transform2) {
  return function(arg) {
    return func(transform2(arg));
  };
}
function setToArray3(set2) {
  var index = -1, result2 = Array(set2.size);
  set2.forEach(function(value) {
    result2[++index] = value;
  });
...
var arrayProto8 = Array.prototype;
var funcProto5 = Function.prototype;
var objectProto31 = Object.prototype;
var coreJsData3 = root3["__core-js_shared__"];
...
var reIsNative3 = RegExp(
  "^" + funcToString5.call(hasOwnProperty27).replace(reRegExpChar4, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
var Buffer4 = moduleExports5 ? root3.Buffer : void 0;
var Symbol3 = root3.Symbol;
var Uint8Array3 = root3.Uint8Array;
var propertyIsEnumerable4 = objectProto31.propertyIsEnumerable;
var splice5 = arrayProto8.splice;
...
var nativeKeys3 = overArg3(Object.keys, Object);
var DataView3 = getNative3(root3, "DataView");
var Map3 = getNative3(root3, "Map");
var Promise4 = getNative3(root3, "Promise");
var Set3 = getNative3(root3, "Set");
var WeakMap4 = getNative3(root3, "WeakMap");
var nativeCreate3 = getNative3(Object, "create");
var dataViewCtorString3 = toSource3(DataView3);
var mapCtorString3 = toSource3(Map3);
var promiseCtorString3 = toSource3(Promise4);
var setCtorString3 = toSource3(Set3);
var weakMapCtorString3 = toSource3(WeakMap4);
var symbolProto5 = Symbol3 ? Symbol3.prototype : void 0;
var symbolValueOf4 = symbolProto5 ? symbolProto5.valueOf : void 0;
...
function hashGet3(key) {
  ...
  if (nativeCreate3) {
    var result2 = data[key];
    return result2 === HASH_UNDEFINED5 ? void 0 : result2;
  }
  return hasOwnProperty27.call(data, key) ? data[key] : void 0;
}
function hashHas3(key) {
  var data = this.__data__;
  return nativeCreate3 ? data[key] !== void 0 : hasOwnProperty27.call(data, key);
}
function hashSet3(key, value) {
  var data = this.__data__;
  this.size += this.has(key) ? 0 : 1;
  data[key] = nativeCreate3 && value === void 0 ? HASH_UNDEFINED5 : value;
  return this;
}
...
function mapCacheDelete3(key) {
  var result2 = getMapData3(this, key)["delete"](key);
  this.size -= result2 ? 1 : 0;
  return result2;
}
...
function mapCacheSet3(key, value) {
  var data = getMapData3(this, key), size2 = data.size;
  data.set(key, value);
  this.size += data.size == size2 ? 0 : 1;
  return this;
}
...
function stackSet3(key, value) {
  ...
  if (data instanceof ListCache3) {
    var pairs = data.__data__;
    if (!Map3 || pairs.length < LARGE_ARRAY_SIZE5 - 1) {
      pairs.push([key, value]);
      this.size = ++data.size;
      return this;
    }
...
function arrayLikeKeys3(value, inherited) {
  var isArr = isArray3(value), isArg = !isArr && isArguments3(value), isBuff = !isArr && !isArg && isBuffer3(value), isType = !isArr && !isArg && !isBuff && isTypedArray2(value), skipIndexes = isArr || isArg || isBuff || isType, result2 = skipIndexes ? baseTimes3(value.length, String) : [], length = result2.length;
  for (var key in value) {
...
function baseGetAllKeys3(object, keysFunc, symbolsFunc) {
  var result2 = keysFunc(object);
  return isArray3(object) ? result2 : arrayPush3(result2, symbolsFunc(object));
}
...
function baseIsArguments2(value) {
  return isObjectLike3(value) && baseGetTag3(value) == argsTag6;
}
...
function baseIsEqualDeep2(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = isArray3(object), othIsArr = isArray3(other), objTag = objIsArr ? arrayTag5 : getTag3(object), othTag = othIsArr ? arrayTag5 : getTag3(other);
...
function baseIsNative3(value) {
  if (!isObject3(value) || isMasked3(value)) {
    return false;
  }
  var pattern = isFunction3(value) ? reIsNative3 : reIsHostCtor3;
  return pattern.test(toSource3(value));
}
function baseIsTypedArray2(value) {
  return isObjectLike3(value) && isLength3(value.length) && !!typedArrayTags2[baseGetTag3(value)];
}
...
function equalObjects2(object, other, bitmask, customizer, equalFunc, stack) {
  var isPartial = bitmask & COMPARE_PARTIAL_FLAG7, objProps = getAllKeys3(object), objLength = objProps.length, othProps = getAllKeys3(other), othLength = othProps.length;
  if (objLength != othLength && !isPartial) {
    return false;
  }
  var index = objLength;
...
var getSymbols3 = !nativeGetSymbols4 ? stubArray3 : function(object) {
  if (object == null) {
    return [];
  }
  object = Object(object);
  return arrayFilter2(nativeGetSymbols4(object), function(symbol) {
    return propertyIsEnumerable4.call(object, symbol);
  });
};
var getTag3 = baseGetTag3;
if (DataView3 && getTag3(new DataView3(new ArrayBuffer(1))) != dataViewTag7 || Map3 && getTag3(new Map3()) != mapTag12 || Promise4 && getTag3(Promise4.resolve()) != promiseTag3 || Set3 && getTag3(new Set3()) != setTag12 || WeakMap4 && getTag3(new WeakMap4()) != weakMapTag6) {
  getTag3 = function(value) {
    var result2 = baseGetTag3(value), Ctor = result2 == objectTag7 ? value.constructor : void 0, ctorString = Ctor ? toSource3(Ctor) : "";
    if (ctorString) {
      switch (ctorString) {
...
function isIndex3(value, length) {
  length = length == null ? MAX_SAFE_INTEGER8 : length;
...
var isArguments3 = baseIsArguments2(/* @__PURE__ */ function() {
  ...
  return isObjectLike3(value) && hasOwnProperty27.call(value, "callee") && !propertyIsEnumerable4.call(value, "callee");
};
...
function isFunction3(value) {
  ...
  return tag == funcTag5 || tag == genTag4 || tag == asyncTag2 || tag == proxyTag2;
}
function isLength3(value) {
  return typeof value == "number" && value > -1 && value % 1 == 0 && value <= MAX_SAFE_INTEGER8;
}
...
module4.exports = isEqual3;
var __CJS__export_default__3 = (module4.exports == null ? {} : module4.exports).default || module4.exports;

// node_modules/quill-delta/dist/AttributeMap.js
var AttributeMap_exports = {};
__export(AttributeMap_exports, {
  default: () => __CJS__export_default__4
});
var module5 = { exports: {} };
var exports5 = module5.exports;
Object.defineProperty(exports5, "__esModule", { value: true });
var cloneDeep3 = Object.keys(lodash_exports).join("") !== "default" ? lodash_exports : __CJS__export_default__2;
var isEqual4 = Object.keys(lodash_exports2).join("") !== "default" ? lodash_exports2 : __CJS__export_default__3;
var AttributeMap;
...
exports5.default = AttributeMap;
var __CJS__export_default__4 = (module5.exports == null ? {} : module5.exports).default || module5.exports;

// node_modules/quill-delta/dist/Op.js
var Op_exports = {};
__export(Op_exports, {
  default: () => __CJS__export_default__5
});
var module6 = { exports: {} };
...
exports6.default = Op;
var __CJS__export_default__5 = (module6.exports == null ? {} : module6.exports).default || module6.exports;

// node_modules/quill-delta/dist/OpIterator.js
var OpIterator_exports = {};
__export(OpIterator_exports, {
  default: () => __CJS__export_default__6
});
var module7 = { exports: {} };
var exports7 = module7.exports;
Object.defineProperty(exports7, "__esModule", { value: true });
var Op_1 = Object.keys(Op_exports).join("") !== "default" ? Op_exports : __CJS__export_default__5;
var Iterator = class {
  constructor(ops) {
    this.ops = ops;
    this.index = 0;
...
exports7.default = Iterator;
var __CJS__export_default__6 = (module7.exports == null ? {} : module7.exports).default || module7.exports;

// node_modules/quill-delta/dist/Delta.js
var module8 = { exports: {} };
var exports8 = module8.exports;
Object.defineProperty(exports8, "__esModule", { value: true });
exports8.AttributeMap = exports8.OpIterator = exports8.Op = void 0;
var diff2 = Object.keys(diff_exports).join("") !== "default" ? diff_exports : __CJS__export_default__;
var cloneDeep4 = Object.keys(lodash_exports).join("") !== "default" ? lodash_exports : __CJS__export_default__2;
var isEqual5 = Object.keys(lodash_exports2).join("") !== "default" ? lodash_exports2 : __CJS__export_default__3;
var AttributeMap_1 = Object.keys(AttributeMap_exports).join("") !== "default" ? AttributeMap_exports : __CJS__export_default__4;
exports8.AttributeMap = AttributeMap_1.default;
var Op_12 = Object.keys(Op_exports).join("") !== "default" ? Op_exports : __CJS__export_default__5;
exports8.Op = Op_12.default;
var OpIterator_1 = Object.keys(OpIterator_exports).join("") !== "default" ? OpIterator_exports : __CJS__export_default__6;
exports8.OpIterator = OpIterator_1.default;
...
var Delta = class _Delta {
  ...
  push(newOp) {
    ...
    if (typeof lastOp === "object") {
      ...
      if (isEqual5(newOp.attributes, lastOp.attributes)) {
    ...
    while (thisIter.hasNext() || otherIter.hasNext()) {
      if (otherIter.peekType() === "insert") {
        ...
        if (otherOp.retain) {
          ...
          delta.push(newOp);
          if (!otherIter.hasNext() && isEqual5(delta.ops[delta.ops.length - 1], newOp)) {
      ...
      while (length > 0) {
        ...
        switch (component[0]) {
          ...
          case diff2.EQUAL:
            ...
            if (isEqual5(thisOp.insert, otherOp.insert)) {
...
Delta.Op = Op_12.default;
Delta.OpIterator = OpIterator_1.default;
Delta.AttributeMap = AttributeMap_1.default;
Delta.handlers = {};
exports8.default = Delta;
if (typeof module8 === "object") {
  module8.exports = Delta;
  module8.exports.default = Delta;
}
var __CJS__export_default__7 = (module8.exports == null ? {} : module8.exports).default || module8.exports;
var __CJS__export_Op__ = (module8.exports == null ? {} : module8.exports).Op;
var __CJS__export_OpIterator__ = (module8.exports == null ? {} : module8.exports).OpIterator;
var __CJS__export_AttributeMap__ = (module8.exports == null ? {} : module8.exports).AttributeMap;
...
var BlockEmbed = class extends EmbedBlot$1 {
  ...
  delta() {
    return new __CJS__export_default__7().insert(this.value(), {
      ...this.formats(),
...
function blockDelta(blot) {
  ...
  }, new __CJS__export_default__7()).insert("\n", bubbleFormats(blot));
}
...
EventEmitter.prototype.removeListener = function removeListener(event, fn, context, once3) {
  var evt = prefix ? prefix + event : event;
...
if ("undefined" !== typeof module9) {
  module9.exports = EventEmitter;
}
var __CJS__export_default__8 = (module9.exports == null ? {} : module9.exports).default || module9.exports;
...
var Emitter = class extends __CJS__export_default__8 {
  constructor() {
    super();
    this.domListeners = {};
...
var Selection = class {
  ...
  getRange() {
    const root4 = this.scroll.domNode;
    if ("isConnected" in root4 && !root4.isConnected) {
      return [null, null];
    }
...
var Editor = class {
  ...
  applyDelta(delta) {
    ...
    const deleteDelta = new __CJS__export_default__7();
    const normalizedOps = splitOpLines(normalizedDelta.ops.slice());
    normalizedOps.reduce((index, op) => {
      const length = __CJS__export_Op__.length(op);
      ...
      if (op.insert != null) {
        ...
        if (typeof op.insert === "string") {
          ...
          attributes = __CJS__export_AttributeMap__.diff(formats, attributes) || {};
    ...
    deleteDelta.reduce((index, op) => {
      ...
      return index + __CJS__export_Op__.length(op);
    }, 0);
  ...
  deleteText(index, length) {
    ...
    return this.update(new __CJS__export_default__7().retain(index).delete(length));
  }
  formatLine(index, length) {
    ...
    this.scroll.optimize();
    const delta = new __CJS__export_default__7().retain(index).retain(length, cloneDeep_default(formats));
  ...
  insertContents(index, contents) {
    ...
    const change = new __CJS__export_default__7().retain(index).concat(normalizedDelta);
    this.scroll.insertContents(index, normalizedDelta);
    return this.update(change);
  }
  insertEmbed(index, embed, value) {
    this.scroll.insertAt(index, embed, value);
    return this.update(new __CJS__export_default__7().retain(index).insert({
      [embed]: value
    }));
  }
  insertText(index, text) {
    ...
    return this.update(new __CJS__export_default__7().retain(index).insert(text, cloneDeep_default(formats)));
  }
  isBlank() {
  ...
  removeFormat(index, length) {
    ...
    let suffixLength = 0;
    let suffix = new __CJS__export_default__7();
    if (line != null) {
      suffixLength = line.length() - offset;
      suffix = line.delta().slice(offset, offset + suffixLength - 1).insert("\n");
    }
    const contents = this.getContents(index, length + suffixLength);
    const diff3 = contents.diff(new __CJS__export_default__7().insert(text).concat(suffix));
    const delta = new __CJS__export_default__7().retain(index).concat(diff3);
  ...
  update(change) {
    ...
    mutations[0].target.data.match(ASCII) && this.scroll.find(mutations[0].target)) {
      ...
      const oldText = new __CJS__export_default__7().insert(oldValue);
      const newText = new __CJS__export_default__7().insert(textBlot.value());
      const relativeSelectionInfo = selectionInfo && {
        oldRange: shiftRange(selectionInfo.oldRange, -index),
        newRange: shiftRange(selectionInfo.newRange, -index)
      };
      const diffDelta = new __CJS__export_default__7().retain(index).concat(oldText.diff(newText, relativeSelectionInfo));
...
var scrollRectIntoView = (root4, targetRect) => {
  var _a, _b, _c;
  const document2 = root4.ownerDocument;
  let rect = targetRect;
  let current = root4;
  while (current) {
...
var _Quill = class _Quill {
  ...
  constructor(container) {
    ...
    this.emitter.on(emitter_default.events.SCROLL_EMBED_UPDATE, (blot, delta) => {
      ...
      modify.call(this, () => {
        const change = new __CJS__export_default__7().retain(blot.offset(this)).retain({
  ...
  format(name, value) {
    ...
    return modify.call(this, () => {
      ...
      let change = new __CJS__export_default__7();
  ...
  setContents(delta) {
    ...
    return modify.call(this, () => {
      delta = new __CJS__export_default__7(delta);
  ...
  setText(text) {
    let source = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : emitter_default.sources.API;
    const delta = new __CJS__export_default__7().insert(text);
...
__publicField(_Quill, "imports", {
  delta: __CJS__export_default__7,
...
function modify(modifier, source, index, shift) {
  if (!this.isEnabled() && source === emitter_default.sources.USER && !this.allowReadOnlyEdits) {
    return new __CJS__export_default__7();
  }
...
var Scroll = class extends ScrollBlot$1 {
  ...
  insertContents(index, delta) {
    const renderBlocks = this.deltaToRenderBlocks(delta.concat(new __CJS__export_default__7().insert("\n")));
    ...
    if (first) {
      ...
      const delta2 = first.type === "block" ? first.delta : new __CJS__export_default__7().insert({
      ...
      const attributes = __CJS__export_AttributeMap__.diff(formats, first.attributes) || {};
      Object.keys(attributes).forEach((name) => {
  ...
  deltaToRenderBlocks(delta) {
    const renderBlocks = [];
    let currentBlockDelta = new __CJS__export_default__7();
    delta.forEach((op) => {
      ...
      if (typeof insert === "string") {
        ...
        splitted.slice(0, -1).forEach((text) => {
          ...
          currentBlockDelta = new __CJS__export_default__7();
        });
...
var Keyboard = class _Keyboard extends module_default {
  ...
  addBinding(keyBinding) {
    ...
    const keys4 = Array.isArray(binding.key) ? binding.key : [binding.key];
    keys4.forEach((key) => {
      const singleBinding = {
        ...binding,
        key,
  ...
  handleBackspace(range2, context) {
    ...
    let delta = new __CJS__export_default__7().retain(range2.index - length).delete(length);
    if (context.offset === 0) {
      ...
      if (prev) {
        ...
        if (!isPrevLineEmpty) {
          ...
          formats = __CJS__export_AttributeMap__.diff(curFormats, prevFormats) || {};
          if (Object.keys(formats).length > 0) {
            const formatDelta = new __CJS__export_default__7().retain(range2.index + line.length() - 2).retain(1, formats);
  ...
  handleDelete(range2, context) {
    ...
    let formats = {};
    const [line] = this.quill.getLine(range2.index);
    let delta = new __CJS__export_default__7().retain(range2.index).delete(length);
    if (context.offset >= line.length() - 1) {
      const [next] = this.quill.getLine(range2.index + 1);
      if (next) {
        const curFormats = line.formats();
        const nextFormats = this.quill.getFormat(range2.index, 1);
        formats = __CJS__export_AttributeMap__.diff(curFormats, nextFormats) || {};
        if (Object.keys(formats).length > 0) {
  ...
  handleEnter(range2, context) {
    ...
    const delta = new __CJS__export_default__7().retain(range2.index).delete(range2.length).insert("\n", lineFormats);
    this.quill.updateContents(delta, Quill.sources.USER);
  ...
  bindings: {
    ...
    "checklist enter": {
      ...
      handler(range2) {
        ...
        const delta = new __CJS__export_default__7().retain(range2.index).insert("\n", formats).retain(line.length() - offset - 1).retain(1, {
          list: "unchecked"
        });
        this.quill.updateContents(delta, Quill.sources.USER);
        this.quill.setSelection(range2.index + 1, Quill.sources.SILENT);
    ...
    "table enter": {
      ...
      format: ["table"],
      handler(range2) {
        const module10 = this.quill.getModule("table");
        if (module10) {
          const [table, row, cell, offset] = module10.getTable(range2);
          const shift = tableSide(table, row, cell, offset);
          if (shift == null) return;
          let index = table.offset();
          if (shift < 0) {
            const delta = new __CJS__export_default__7().retain(index).insert("\n");
            this.quill.updateContents(delta, Quill.sources.USER);
    ...
    "list autofill": {
      ...
      handler(range2, context) {
        ...
        this.quill.history.cutoff();
        const delta = new __CJS__export_default__7().retain(range2.index - offset).delete(length + 1).retain(line.length() - 2 - offset).retain(1, {
          list: value
        });
        this.quill.updateContents(delta, Quill.sources.USER);
        this.quill.history.cutoff();
    ...
    "code exit": {
      ...
      handler(range2) {
        ...
        while (cur != null && cur.length() <= 1 && cur.formats()["code-block"]) {
          ...
          numLines -= 1;
          if (numLines <= 0) {
            const delta = new __CJS__export_default__7().retain(range2.index + line.length() - offset - 2).retain(1, {
              "code-block": null
            }).delete(1);
            this.quill.updateContents(delta, Quill.sources.USER);
            this.quill.setSelection(range2.index - 1, Quill.sources.SILENT);
...
function deleteRange(_ref2) {
  ...
  if (lines.length > 1) {
    ...
    formats = __CJS__export_AttributeMap__.diff(lastFormats, firstFormats) || {};
  }
...
var Clipboard = class extends module_default {
  ...
  convert(_ref2) {
    ...
    if (formats[CodeBlock.blotName]) {
      return new __CJS__export_default__7().insert(text || "", {
        [CodeBlock.blotName]: formats[CodeBlock.blotName]
      });
    }
    if (!html) {
      return new __CJS__export_default__7().insert(text || "", formats);
    }
    const delta = this.convertHTML(html);
    if (deltaEndsWith(delta, "\n") && (delta.ops[delta.ops.length - 1].attributes == null || formats.table)) {
      return delta.compose(new __CJS__export_default__7().retain(delta.length() - 1).delete(1));
    }
    return delta;
  }
  normalizeHTML(doc) {
  ...
  dangerouslyPasteHTML(index, html) {
    ...
    if (typeof index === "string") {
      ...
      this.quill.updateContents(new __CJS__export_default__7().retain(index).concat(paste), source);
  ...
  onPaste(range2, _ref3) {
    ...
    const delta = new __CJS__export_default__7().retain(range2.index).delete(range2.length).concat(pastedDelta);
    this.quill.updateContents(delta, Quill.sources.USER);
...
function matchBlot(node, delta, scroll) {
  ...
  if (match2.prototype instanceof EmbedBlot$1) {
    ...
    if (value != null) {
      ...
      return new __CJS__export_default__7().insert(embed, match2.formats(node, scroll));
    }
  } else {
...
function matchStyles(node, delta, scroll) {
  ...
  if (parseFloat(style.textIndent || 0) > 0) {
    return new __CJS__export_default__7().insert("	").concat(delta);
  }
  return delta;
}
...
Uploader.DEFAULTS = {
  ...
  handler(range2, files) {
    ...
    Promise.all(promises).then((images) => {
      ...
      }, new __CJS__export_default__7().retain(range2.index).delete(range2.length));
...
var Input = class extends module_default {
  ...
  replaceText(range2) {
    ...
    if (text) {
      ...
      this.quill.updateContents(new __CJS__export_default__7().retain(range2.index).insert(text, formats), Quill.sources.USER);
    } else {
      this.deleteRange(range2);
    }
...
var Syntax = class extends module_default {
  ...
  highlightBlot(text) {
    ...
    return traverse(this.quill.scroll, container, [(node, delta) => {
      ...
      if (value) {
        return delta.compose(new __CJS__export_default__7().retain(delta.length(), {
...
var Table = class extends module_default {
  ...
  insertTable(rows, columns) {
    ...
    }, new __CJS__export_default__7().retain(range2.index));
    this.quill.updateContents(delta, Quill.sources.USER);
  ...
  attach(input) {
    ...
    input.addEventListener(eventName, (e) => {
      ...
      if (this.handlers[format] != null) {
        ...
        if (!value) return;
        this.quill.updateContents(new __CJS__export_default__7().retain(range2.index).delete(range2.length).insert({
          [format]: value
        }), Quill.sources.USER);
      } else {
...
var BaseTheme = class extends theme_default {
  ...
  addModule(name) {
    const module10 = super.addModule(name);
    if (name === "toolbar") {
      this.extendToolbar(module10);
    }
    return module10;
  }
...
export {
  __CJS__export_AttributeMap__ as AttributeMap,
  __CJS__export_default__7 as Delta,
  module_default as Module,
  __CJS__export_Op__ as Op,
  __CJS__export_OpIterator__ as OpIterator,
