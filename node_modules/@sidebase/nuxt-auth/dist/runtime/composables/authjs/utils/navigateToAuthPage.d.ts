...
export declare function navigateToAuthPageWN(nuxt: NuxtApp, href: string): Promise<void> | Promise<Promise<void>>;
/**
 ...
 */
export declare function navigateToAuthPage(href: string): Promise<void>;
